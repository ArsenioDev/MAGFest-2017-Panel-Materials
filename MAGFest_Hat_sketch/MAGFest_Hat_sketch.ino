...
#define MIC_PIN    A2  // Microphone is attached to  pin 2 A1 on the Trinket
#define LED_PIN    7  // NeoPixel LED strand attached to pin 0 on Trinket
#define N_PIXELS   26   // number of pixels in LED strand
#define N           100  // Number of samples to take each time readSamples is called
#define fadeDelay  9  // delay time for each fade amount
#define noiseLevel 4 // slope level of average mic noise without sound 
